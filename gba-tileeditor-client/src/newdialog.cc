...
void NewDialog::setup_triggers(Ui_NewMapDialog* nd)
{
    ...
    QObject::connect(nd->actionCancel, SIGNAL(triggered()), this,
                     SLOT(nd_cancel()));
    combo = nd->comboBox;
    ...
    QObject::connect(nd->actionRegular, SIGNAL(triggered()), this,
                     SLOT(on_regular()));
    QObject::connect(nd->actionAffine, SIGNAL(triggered()), this,
                     SLOT(on_affine()));
}
